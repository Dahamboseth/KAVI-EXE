...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "NdYhXRLT#_tYmegRdI338XnmVIORS0u9QGG3J7P0eoi2KDs8hv8E",
...
AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "*SEEN YOUR STATUS BY DAHAM🐼 🤍*",
};
